...
function clearBtn() {
  ...
  if (clearBtn) {
    // Do nothing if button already exists
  } else {
    let clear = document.createElement("div");
    clear.id = "clear";
    clear.innerHTML = `<button class="clear_btn">Clear selections(x)</button>`;
    clear.addEventListener("click", () => {
      selected_Genre = [];
      SetGenre();
      getMovies(API_URL);
    });
    document.getElementById("tags").append(clear); // Ensure 'tags' container exists
  }
}
